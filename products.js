        ...
        <div class="col">
            <div class="card h-100 disp bg-light">
             <div class="position-relative">
              <img src=${p1.image} class="card-img-top position-relative" alt="...">
...
function disptopfprod()
{
    vege.slice(1,3).map((p2)=>{
        ...
        <div class="col">
            <div class="card h-100 disp bg-light">
             <div class="position-relative">
              <img src=${p2.image} class="card-img-top position-relative" alt="...">
...
function dispsellprod()
{
    vege.filter((p3)=>{
        ...
        <div class="col">
            <div class="card h-100 disp bg-light">
             <div class="position-relative">
              <img src=${p3.image} class="card-img-top position-relative" alt="...">
